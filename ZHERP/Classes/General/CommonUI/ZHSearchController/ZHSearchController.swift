...
fileprivate let ZHSearchTintColor = RGBA(r: 0.12, g: 0.74, b: 0.13, a: 1.00)

class ZHSearchController: UISearchController {
    ...
    func setup() {
        ...
        searchBar.tintColor = ZHSearchTintColor
        // 去除上下两条横线
    ...
    @objc func findCancel() {
        ...
        if btn.isKind(of: NSClassFromString("UINavigationButton")!) {
            ...
            cancel.setTitleColor(ZHSearchTintColor, for: .normal)
...
extension ZHSearchController: UISearchBarDelegate {
