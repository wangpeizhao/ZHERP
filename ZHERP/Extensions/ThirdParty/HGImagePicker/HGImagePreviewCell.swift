...
class HGImagePreviewCell: UICollectionViewCell {
...
//HGImagePreviewCell的UIScrollViewDelegate代理实现
extension HGImagePreviewCell:UIScrollViewDelegate{
