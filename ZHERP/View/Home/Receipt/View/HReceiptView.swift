...
class HReceiptView: UIViewController {
    ...
    public func mainView(initData: [String: String]) -> UIView {
        ...
        _paymentCodeView.snp.makeConstraints { (make) -> Void in
            ...
            make.top.equalTo(_mainView.snp.top).offset(20)
        }
        ...
        _separator.snp.makeConstraints { (make) -> Void in
            make.top.equalTo(_alipayLabel.snp.bottom).offset(10)
        ...
        self.continuePickBtn.setTitle("我要拣货", for: .normal)
