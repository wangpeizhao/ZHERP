...
class GoodTableViewController: UITableViewController {
    ...
    let identifier: String = "GoodIdentifier"
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tableView.register(UITableViewCell.self, forCellReuseIdentifier: "Cell")
        
        buildSearchBar(searchBar: searchController.searchBar, placeholder: "按商品名称搜索")
...
extension GoodTableViewController: UISearchResultsUpdating {
...
extension GoodTableViewController: UISearchBarDelegate {
