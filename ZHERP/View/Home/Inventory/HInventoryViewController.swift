//
//  HInventoryViewController.swift
//  ZHERP
//
...
class HInventoryViewController: UIViewController {
...
extension HInventoryViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let _target = HInventoryResultViewController()
