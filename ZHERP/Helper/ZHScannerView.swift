...
class ZHScannerView: UIView {
    ...
    init(frame: CGRect, config: ZHQRCodeConfig) {
    ...
    @objc func flashlightClicked(button: UIButton) {
        ...
        zh_setFlashlight(on: button.isSelected)
    }
    ...
    lazy var scannerLine: UIImageView = {
        ...
        tempScannerLine.image = UIImage(named: "ZHQRCode.bundle/ScannerLine")
    ...
    lazy var flashlightBtn: UIButton = {
        ...
        tempFlashlightBtn.setBackgroundImage(UIImage(named: "ZHQRCode.bundle/Flashlight_Off"), for: .normal)
        tempFlashlightBtn.setBackgroundImage(UIImage(named: "ZHQRCode.bundle/Flashlight_On"), for: .selected)
...
// MARK: - 扫描线条动画
extension ZHScannerView {
    
    /** 添加扫描线条动画 */
    func zh_addScannerLineAnimation() {
        // 若已添加动画，则先移除动画再添加
    ...
    /** 暂停扫描器动画 */
    func zh_pauseScannerLineAnimation() {
        // 取出当前时间，转成动画暂停的时间
...
extension ZHScannerView {
    ...
    /** 显示手电筒 */
    func zh_showFlashlight(animated: Bool) {
        if animated {
    ...
    /** 隐藏手电筒 */
    func zh_hideFlashlight(animated: Bool) {
...
extension ZHScannerView {
    ...
    /** 移除指示器 */
    func zh_removeActivityIndicator() {
        if self.activityIndicator != nil {
...
extension ZHScannerView {
    ...
    /** 设置手电筒开关 */
    func zh_setFlashlight(on: Bool) {
        ZHQRCodeManager.zh_flashlight(on: on)
